				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-start">
						<div class="banner-content col-lg-12 col-md-12">
							...
							<a href="withdraw.php" class="primary-btn header-btn text-uppercase">WITHDRAW</a>
							<a href="diposite.php" class="primary-btn header-btn text-uppercase">DIPOSITE</a>
							<a href="transfer.php" class="primary-btn header-btn text-uppercase">TRANSFER MONEY</a>
						<a href="loan.php" class="primary-btn header-btn text-uppercase">LOAN</a>
						</div>												
					</div>
				</div>
			</section>
				...
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="col-md-9 pb-40 header-text">
							<h1>show your balance</h1>
							<p>
								Who are in extremely love with eco friendly system.
							</p>
							<button onclick="showbalance()">show it now </button>
						</div>
					</div>
					<div class="row">
