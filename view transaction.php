					...
					<div class="row height align-items-center justify-content-center">
						<div class="col-lg-10">
							<div class="generic-banner-content">
								<h2 class="text-white">Search members feedback </h2>
...
-->
			...
			<span><h3 class="mb-30">member name:</h3><h4>bebeeeb</h4></span>
			<span><h3 class="mb-30">id:</h3></span>
						<div class="progress-table-wrap">
							<div class="progress-table">
								<div class="table-head">
									<div class="serial">#</div>
									<div class="country">date</div>
									<div class="visit">transaction type</div>
							...
							<span><h3  class="mb-30" style="margin-left: 40px;">total balance :</h3><div></div></span> 
						</div>
